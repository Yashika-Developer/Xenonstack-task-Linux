...
man internsctl
```
<img src="./docs/a.jpg" height="350" width="650" style="border: 1px solid black;">
<br>
<img src="./docs/b.jpg" height="350" width="650" style="border: 1px solid black;">
...
internsctl --help
```
<img src="./docs/c.jpg" height="350" width="650" style="border: 1px solid black;">
...
internsctl --version
```
<img src="./docs/d.jpg" height="350" width="650" style="border: 1px solid black;">
...
```
<img src="./docs/e.jpg" height="350" width="650" style="border: 1px solid black;">
...
```
<img src="./docs/f.jpg" height="350" width="650" style="border: 1px solid black;">
...
```
<img src="./docs/g.jpg" height="350" width="650" style="border: 1px solid black;">
<img src="./docs/h.jpg" height="350" width="650" style="border: 1px solid black;">
